...
CSV_PATH = r"C:/Users/tasis/Desktop/sxoli/DISTRIBUTED_SYSTEMS/test/output.csv"
PICKLE_PATH = r"C:/Users/tasis/Desktop/sxoli/DISTRIBUTED_SYSTEMS/test/my_dht.pkl"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if not results or not results[0][2]:
            ...
            print(f"\nΒρέθηκαν {len(movie_list)} αποτελέσματα στον {owner} ({hops} hops):")
            print("-" * 50)
            
            for i, movie in enumerate(movie_list, 1):
                print(f"ΑΠΟΤΕΛΕΣΜΑ {i}:")
                for field, value in movie.items():
                    print(f"  {field}: {value}")
                print("-" * 30)
        
        print(f"Χρόνος αναζήτησης: {end - start:.6f} δευτερόλεπτα")